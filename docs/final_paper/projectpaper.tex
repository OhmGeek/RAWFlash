...
\subsubsection{Unsharp Image Adjustment}
    ...
    Using standard Contrast Stretching does work, but seems to make the entire image washed out, which isn't what we are directly trying to achieve
    (as we just want the image as we had before, only improved).
...
\subsection{Improving performance of fetching RAW files}
