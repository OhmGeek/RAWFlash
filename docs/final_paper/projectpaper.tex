...
Utilising a sample RAW image, output from various different RAW editors was analysed and compared to our system,
to determine the image quality of our system, when editing. Functionality of our system was also tested using
boundary conditions and test cases, to ensure the system was functioning correctly. Furthermore, statistics on
the processing times of different RAW editors were analysed, to analyse the performance of our system for standard
